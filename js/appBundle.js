...
(function (AntSharesApp) {
    ...
    (function (Application) {
        ...
        function onResume() {
            if (noResume) {
                setTimeout(function () { noResume = false; }, 60000);
                return;
            }
            var gesturePwd = getCookie("gesturePwd");
            if (gesturePwd == "") {
        ...
        var passphrase = "Choose a passphrase to encrypt your existing private key";
        var WIF = "KxxGondAgjXQiVAGAsSUdrAq5nLbkkTDqBg4hMA4vbxURf1Scvz1";
        var encrypt;
        var DEFAULT_SCRYPT = {
            cost: 16384,
            blockSize: 8,
        ...
        var NEP_HEADER = '0142';
        function encryptWIF(WIF, passphrase) {
            return Promise.resolve(encrypt(WIF, passphrase));
        }
        function decryptWIF(encrypted, passphrase) {
        }
        function encrypts(wif, passphrase) {
            var address = "AKoG1LmxMSTmT9kNwuomTWHhN1zNeKbrjW";
            var addressHash = address.hexToBytes();
            console.log(addressHash);
            window.crypto.subtle.digest({ name: "SHA-256" }, addressHash).then(function (result) {
                console.log(result);
                window.crypto.subtle.digest({ name: "SHA-256" }, new Uint8Array(result)).then(function (result) {
                    console.log(result);
                    return result.toString().slice(0, 8);
                });
            });
            var derived1;
            var privateInput = "KxxGondAgjXQiVAGAsSUdrAq5nLbkkTDqBg4hMA4vbxURf1Scvz1";
            var privateKey;
            var xor = privateKey ^ derived1;
        }
        Application.encrypts = encrypts;
    })(Application = AntSharesApp.Application || (AntSharesApp.Application = {}));
...
(function (AntShares) {
    ...
    var Fixed8 = (function () {
        ...
        Object.defineProperty(Fixed8, "MaxValue", {
            get: function () { return _max || (_max = new Fixed8(new AntShares.Uint64(0xffffffff, 0x7fffffff))); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Fixed8, "MinusOne", {
            get: function () { return _minus || (_minus = new Fixed8(new AntShares.Uint64(0xffffffff, 0xffffffff))); },
            enumerable: true,
            configurable: true
        });
    ...
    (function (Wallets) {
        var Contract = (function () {
            ...
            Contract.createMultiSigContract = function (publicKeyHash, m, publicKeys) {
                ...
                var parameterList = AntShares.Linq.Enumerator.repeat(Wallets.ContractParameterType.Signature, m).toArray();
        ...
        var Wallet = (function () {
                ...
                return Promise.resolve(typeof password === "string" ? password.toAesKey() : password).then(function (result) {
                    ...
                    if (create) {
                        ...
                        return Promise.all([
                            ...
                            _this.coins = new AntShares.IO.Caching.TrackableCollection(results[2]);
            ...
            Wallet.prototype.processBlocks = function () {
                ...
                Promise.resolve(AntShares.Core.Blockchain.Default == null ? 0 : AntShares.Core.Blockchain.Default.getBlockCount()).then(function (result) {
                    ...
                    setTimeout(_this.processBlocks.bind(_this), AntShares.Global.reConnectMultiplier * 1000);
...
(function (AntShares) {
    ...
    })(Linq = AntShares.Linq || (AntShares.Linq = {}));
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
    var Linq;
                ...
                var IndexedDBWallet = (function (_super) {
                    ...
                    IndexedDBWallet.prototype.getTransactions = function (type) {
                        ...
                        transaction.store("Transaction").index("type").openCursor(keyRange).onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                                array.push(AntShares.Core.Transaction.deserializeFrom(cursor.value.rawData.hexToBytes().buffer));
                                cursor.continue();
                            }
                        };
                        return transaction.commit().then(function () {
            ...
            Object.defineProperty(Blockchain, "GenesisBlock", {
                get: function () {
                    if (Blockchain._GenesisBlock == null) {
                        Blockchain._GenesisBlock = "".hexToBytes().asSerializable(Core.Block);
                    }
    ...
    (function (Core) {
        var InvocationTransaction = (function (_super) {
            ...
            InvocationTransaction.prototype.deserializeExclusiveData = function (reader) {
                ...
                if (this.version >= 1) {
                    this.gas = reader.readSerializable(AntShares.Fixed8);
                    if (this.gas < AntShares.Fixed8.Zero)
                        throw new Error("格式错误");
                }
                else {
                    this.gas = AntShares.Fixed8.Zero;
                }
            };
    ...
    (function (Core) {
        var RegisterTransaction = (function (_super) {
            ...
            Object.defineProperty(RegisterTransaction.prototype, "systemFee", {
                get: function () {
                    return this.assetType == Core.AssetType.AntShare || this.assetType == Core.AssetType.AntCoin ? AntShares.Fixed8.Zero : AntShares.Fixed8.fromNumber(10000);
                },
                enumerable: true,
                configurable: true
            });
    ...
    (function (Core) {
        var SignatureContext = (function () {
            ...
            SignatureContext.fromJson = function (json) {
                ...
                var signable = new t();
                var ms = new AntShares.IO.MemoryStream(json["hex"].hexToBytes(), false);
                var reader = new AntShares.IO.BinaryReader(ms);
                    ...
                    for (var i = 0; i < json["scripts"].length; i++) {
                        if (json["scripts"][i] != null) {
                            ...
                            for (var j = 0; j < sigs.length; j++) {
                                var pubkey = AntShares.Cryptography.ECPoint.decodePoint(sigs[j]["pubkey"].hexToBytes(), AntShares.Cryptography.ECCurve.secp256r1);
...
(function (AntShares) {
    var Global = (function () {
        ...
        Global.chooseNode = function () {
            var isChoosed = false;
            var seed2 = new AntShares.Network.RPC.RpcClient("https://seed2.antshares.org:10331");
            var seed8 = new AntShares.Network.RPC.RpcClient("https://seed8.antshares.org:10331");
            var start = new Date().getTime();
            new AntShares.Implementations.Blockchains.RPC.RpcBlockchain(seed2).getBlockCount().then(function (result) {
                var end = new Date().getTime();
                var timeSpan = end - start;
                $("#seed2").text(timeSpan);
                if (!isChoosed) {
                    isChoosed = true;
                    Global.Blockchain = AntShares.Core.Blockchain.registerBlockchain(new AntShares.Implementations.Blockchains.RPC.RpcBlockchain(seed2));
                    $("#seed").text("中国上海 https://seed2.antshares.org:10331");
                }
            });
            var start2 = new Date().getTime();
            new AntShares.Implementations.Blockchains.RPC.RpcBlockchain(seed8).getBlockCount().then(function (result) {
                var end2 = new Date().getTime();
                var timeSpan2 = end2 - start2;
                $("#seed8").text(timeSpan2);
                if (!isChoosed) {
                    isChoosed = true;
                    Global.Blockchain = AntShares.Core.Blockchain.registerBlockchain(new AntShares.Implementations.Blockchains.RPC.RpcBlockchain(seed8));
    ...
    Global.mainHttpNetList = ["http://seed1.neo.org:10332", "http://seed2.neo.org:10332", "http://seed3.neo.org:10332", "http://seed4.neo.org:10332", "http://seed5.neo.org:10332"];
    Global.mainHttpsNetList = ["https://seed3.neo.org:10331", "https://seed1.neo.org:10331"];
    Global.testNetList = ["http://seed1.antshares.org:20332", "http://seed2.antshares.org:20332", "http://seed3.antshares.org:20332", "http://seed4.antshares.org:20332", "http://seed5.antshares.org:20332"];
    AntShares.Global = Global;
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
    var Sync = (function () {
        ...
        Sync.callNode = function (node) {
            var dictionary = new Map();
            var rpcClient = new AntShares.Network.RPC.RpcClient(node);
            return rpcClient.call("getblockcount", []).then(function (result) {
        ...
        Sync.connectNode = function (isMainNet) {
            debugLog("启动连接");
            Promise.resolve(1).then(function () {
                ...
                if (isMainNet) {
                    if (isMobileApp.App()) {
                        nodeList = AntShares.Global.mainHttpNetList;
                    }
                    else {
                        nodeList = AntShares.Global.mainHttpsNetList;
                    }
                }
                else {
                    nodeList = AntShares.Global.testNetList;
                }
                ...
                var node;
                for (var i = 0; i < results.length; i++) {
                    if (results[i].has(true)) {
                        AntShares.Global.isConnected = true;
                        node = results[i].get(true);
                        break;
                    }
                }
                if (AntShares.Global.isConnected) {
                    if (AntShares.Global.RpcClient == null) {
                        AntShares.Global.RpcClient = new AntShares.Network.RPC.RpcClient(node);
                        AntShares.Global.Blockchain = AntShares.Core.Blockchain.registerBlockchain(new AntShares.Implementations.Blockchains.RPC.RpcBlockchain(AntShares.Global.RpcClient));
                        AntShares.Global.Node = new AntShares.Network.RemoteNode(AntShares.Global.RpcClient);
                    }
                    else {
                        if (AntShares.Global.RpcClient.Url != node) {
                            AntShares.Global.RpcClient = new AntShares.Network.RPC.RpcClient(node);
                            AntShares.Global.Blockchain = AntShares.Core.Blockchain.registerBlockchain(new AntShares.Implementations.Blockchains.RPC.RpcBlockchain(AntShares.Global.RpcClient));
                            AntShares.Global.Node = new AntShares.Network.RemoteNode(AntShares.Global.RpcClient);
                        }
                ...
                return AntShares.Global.Blockchain.getBlockCount();
            }).then(function (result) {
                var remoteHeight = result - 1;
                $(".remote_height").text(remoteHeight);
                if (AntShares.Global.Wallet) {
                    var localHeight = AntShares.Global.Wallet.walletHeight - 1;
                    var process = (localHeight / remoteHeight * 100).toFixed(1);
                ...
                AntShares.Sync.connectNode(AntShares.Global.isMainNet);
            }).catch(function (error) {
                debugLog("网络连接中断");
                return delay(AntShares.Global.reConnectMultiplier * 1000).then(function () {
                    return AntShares.Sync.connectNode(AntShares.Global.isMainNet);
                });
            });
        };
        return Sync;
    ...
    (function (Wallets) {
        var Master = (function (_super) {
            ...
            Master.prototype.add = function (name) {
                return AntShares.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Wallet", "readwrite").store("Wallet").put({ name: name }));
            };
            Master.prototype.clear = function () {
                return AntShares.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Wallet", "readwrite").store("Wallet").clear());
            };
            Master.prototype.delete = function (name) {
                return AntShares.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Wallet", "readwrite").store("Wallet").delete(name));
            };
            ...
            return Master;
        }(AntShares.Implementations.Wallets.IndexedDB.DbContext));
...
(function (AntShares) {
    var UI;
    (function (UI) {
        var TabBase = (function () {
            function TabBase() {
            }
            TabBase.prototype.oncreate = function () { };
            TabBase.prototype.onload = function (args) { };
            TabBase.showTab = function (id) {
                var args = [];
                for (var _i = 1; _i < arguments.length; _i++) {
                ...
                $(id).addClass("active");
                var className = id.replace("#Tab_", "AntShares.UI.").replace(/_/g, '.');
                var tab;
...
(function (AntShares) {
    ...
    (function (UI) {
        var Resources = (function () {
            ...
            Object.defineProperty(Resources, "global", {
                get: function () {
        ...
        var global_zh = (function () {
            function global_zh() {
            }
            return global_zh;
        }());
        global_zh.openWalletAlert = "打开钱包成功";
        global_zh.createWalletAlert = "创建钱包成功";
        global_zh.createAccountAlert = "创建账户成功";
        global_zh.importAccountAlert = "导入账户成功";
        global_zh.pleaseInputData = "请输入数据";
        global_zh.WIFis = 'WIF格式的私钥为：';
        global_zh.dataFormatError = "数据格式有误";
        global_zh.relaySuccess = "数据广播成功";
        global_zh.relayFaild = "数据广播失败";
        global_zh.insufficientFunds = "余额不足";
        global_zh.canNotSign = "无法签名";
        global_zh.thisVersion1 = "当前版本APP不支持多方签名或接收方签名的交易";
        global_zh.txError1 = "钱包金额已发生变化，交易无法完成";
        global_zh.electionInfo = "选举信息已经发送，等待区块确认";
        global_zh.voteInfo = "投票信息已经发送，等待区块确认";
        global_zh.issueInfo = "分发资产信息已经发送，等待区块确认";
        global_zh.registInfo = "注册资产信息已经发送，等待区块确认，交易ID: ";
        global_zh.contractInfo = "交易信息已经发送，等待区块确认";
        global_zh.publisher = "发行者";
        global_zh.admin = "管理员";
        global_zh.amount = "总量";
        global_zh.sameWalletName = "已经存在重名的钱包文件，你可以打开钱包或者创建新的钱包。";
        global_zh.sameWalletName1 = "已经存在重名的钱包文件";
        global_zh.selectAssetType = "请选择资产类型";
        global_zh.pleaseChoose = "请选择";
        global_zh.signFinish = "完成签名";
        global_zh.signError1 = "没有足够的私钥对数据进行签名";
        global_zh.walletJsonError = "钱包格式有误，不正确的JSON格式";
        global_zh.createMultiContractError = "无法添加多方签名合约，因为当前钱包中不包含签署该合约的私钥。";
        global_zh.createMultiContractSuccess = "智能合约创建成功";
        global_zh.changePwdSuccess = "修改钱包密码成功";
        global_zh.menu = "菜单";
        global_zh.walletName = "钱包名称";
        global_zh.walletNameRequired = "钱包名称不能为空";
        global_zh.createPasswordPlaceholder = "钱包密码";
        global_zh.createPasswordRequired = "钱包密码不能为空";
        global_zh.createPasswordLength = "密码必须至少包含 8 个字符";
        global_zh.createPasswordConfirmPlaceholder = "钱包密码";
        global_zh.createPasswordConfirmRequired = "确认密码不能为空";
        global_zh.createPasswordConfirmEqualtoOther = "密码和确认密码不匹配";
        global_zh.inputWalletNamePlaceholder = "钱包名称";
        global_zh.openPasswordPlaceholder = "钱包密码";
        global_zh.openPasswordRequired = "钱包密码不能为空";
        global_zh.oldPasswordPlaceholder = "钱包密码";
        global_zh.oldPasswordRequired = "钱包密码不能为空";
        global_zh.newPasswordPlaceholder = "钱包密码";
        global_zh.newPasswordRequired = "钱包密码不能为空";
        global_zh.newPasswordLength = "密码必须至少包含8个字符";
        global_zh.newPasswordConfirmPlaceholder = "钱包密码";
        global_zh.newPasswordConfirmRequired = "确认密码不能为空";
        global_zh.newPasswordConfirmEqualto = "密码和确认密码不匹配";
        global_zh.importPrikeyInputPlaceholder = "输入私钥，要求WIF格式";
        global_zh.importPrikeyInputRequired = "私钥不能为空";
        global_zh.importPrikeyInputLength = "私钥必须是52位的Base58编码格式";
        global_zh.inputMPlaceholder = "最小为1";
        global_zh.inputMRequired = "最小签名数量不能为空";
        global_zh.publicInputTplPlaceholder = "公钥";
        global_zh.publickeyitemPlaceholder = "公钥";
        global_zh.addPublicTitle = "添加公钥";
        global_zh.transferTxoutPlaceholder = "对方Neo地址";
        global_zh.transferValuePlaceholder = "金额";
        global_zh.inputDataPlaceholder = "待签名的交易";
        global_zh.inputAssetNamePlaceholder = "输入资产名称";
        global_zh.inputAmountPlaceholder = "输入资产总量";
        global_zh.issueOutputAddrPlaceholder = "地址";
        global_zh.issueOutputValuePlaceholder = "金额";
        global_zh.inputAntcoinPlaceholder = "输入抵押的Gas数量";
        global_zh.relayDataPlaceholder = "要广播的数据包";
        global_zh.addInputTitle = "添加输出";
        global_zh.accountAlreadyExits = "该账户已经存在";
        global_zh.theAntsharesSystem = "Neo系统";
        global_zh.transferTxoutRequired = "对方Neo地址不能为空";
        global_zh.transferValueRequired = "交易金额不能为空";
        global_zh.transferAssetRequired = "交易资产不能为空";
        global_zh.assetNameRequired = "资产名称不能为空";
        global_zh.assetAmountRequired = "资产总量不能为空";
        global_zh.issueAssetsRequired = "分发资产不能为空";
        global_zh.relayDataRequired = "数据包不能为空";
        global_zh.inputDataRequired = "待签名的交易不能为空";
        global_zh.issuer = "发行人： ";
        global_zh.issuerPubKey = "发行人公钥： ";
        global_zh.unConfirmed = "未确认";
        global_zh.minerTx = "矿工交易";
        global_zh.issueTx = "资产发行";
        global_zh.claimTx = "提取Gas";
        global_zh.enrollmentTx = "记账报名";
        global_zh.registerTx = "资产注册";
        global_zh.contractTx = "合约交易";
        global_zh.agencyTx = "代理交易";
        global_zh.publishTx = "合约发布";
        global_zh.noTxs = "您目前还没有交易";
        global_zh.RPCError = "很抱歉，网络连接失败，暂时不能创建钱包，请过一会儿再试。";
        global_zh.txId = "交易已经发送，等待区块确认，交易id: ";
        global_zh.addressError = "地址信息有误";
        global_zh.contactAddressRequired = "地址不能为空";
        global_zh.contactNameRequired = "姓名不能为空";
        global_zh.contactNameLength = "姓名不能超过20个字符";
        global_zh.contactAddressRegex = "地址格式不正确";
        global_zh.contactNameRegex = "姓名不正确";
        global_zh.transferTxoutRegex = "地址格式不正确";
        global_zh.privateIsWrong = "私钥格式不正确";
        global_zh.pleaseChooseAsset = "请选择资产";
        global_zh.createWallet = "创建钱包";
        global_zh.pleaseWait = "请稍候...";
        global_zh.importPrikey = "导入私钥";
        global_zh.transferValueRegex = "金额输入错误";
        global_zh.browserIndexedb = "该浏览器不支持IndexedDB，无法使用Neo App.";
        global_zh.browserError = "无法在微信/QQ/微博的内置浏览器中使用Neo钱包，请下载Neo App.";
        global_zh.contactExists = "已经添加过该联系人。";
        global_zh.showReceiveAddress = "现在你可以点击“收款”查看到你的收款地址了";
        global_zh.netError = "网络异常！";
        global_zh.antshareIntegerOnly = "Neo转账金额只能为整数";
        global_zh.gesturePwdWrong = "两次绘制的图案不一致，请重新绘制";
        var global_en = (function () {
            function global_en() {
            }
            return global_en;
        }());
        global_en.openWalletAlert = "Wallet Open Complete";
        global_en.createWalletAlert = "Wallet Creation Complete";
        global_en.createAccountAlert = "Account Creation Complete";
        global_en.importAccountAlert = "Account Import Complete";
        global_en.pleaseInputData = "Please input data";
        global_en.WIFis = 'Private Key in WIF format: ';
        global_en.dataFormatError = "Incorrect Data Format";
        global_en.relaySuccess = "Broadcast Successful";
        global_en.relayFaild = "Broadcast Failed";
        global_en.insufficientFunds = "Insufficient Funds";
        global_en.canNotSign = "Signing Failed";
        global_en.thisVersion1 = "Multi-Sig and Recipient Sig transactions not supported under current App version";
        global_en.txError1 = "Wallet Balance changed, transaction failed";
        global_en.electionInfo = "Election Info. Transmitted, pending confirmation";
        global_en.voteInfo = "Voting Info. Transmitted, pending confirmation";
        global_en.issueInfo = "Asset Distribution Info. Transmitted, pending confirmation";
        global_en.registInfo = "Asset has been registered, please wait for confirmations, txid= ";
        global_en.contractInfo = "Transaction Info. Transmitted, pending confirmation";
        global_en.publisher = "Issuer";
        global_en.admin = "Administrator";
        global_en.amount = "Total Amount";
        global_en.sameWalletName = "Wallet File already exist, open this wallet or create one under a new name";
        global_en.sameWalletName1 = "Wallet File already exist";
        global_en.selectAssetType = "Please select the type of the asset";
        global_en.pleaseChoose = "Select";
        global_en.signFinish = "Signautre Complete";
        global_en.signError1 = "Insufficient Private Keys to complete this signing";
        global_en.walletJsonError = "Incorrect Wallet Format, JSON format error";
        global_en.createMultiContractError = "Multi-Sig Contract failed, private key to this contract not in the wallet";
        global_en.createMultiContractSuccess = "Smart Contract Creation Complete";
        global_en.changePwdSuccess = "Wallet Password Change Complete";
        global_en.menu = "Menu";
        global_en.walletName = "wallet name";
        global_en.walletNameRequired = "Wallet name is required";
        global_en.createPasswordPlaceholder = "wallet password";
        global_en.createPasswordRequired = "Wallet password is required";
        global_en.createPasswordLength = "The password must be at least 8 bits long";
        global_en.createPasswordConfirmPlaceholder = "wallet password";
        global_en.createPasswordConfirmRequired = "Password confirm is required";
        global_en.createPasswordConfirmEqualtoOther = "Password and confirm password do not match";
        global_en.inputWalletNamePlaceholder = "wallet name";
        global_en.openPasswordPlaceholder = "wallet password";
        global_en.openPasswordRequired = "Wallet password is required";
        global_en.oldPasswordPlaceholder = "wallet password";
        global_en.oldPasswordRequired = "Wallet password is required";
        global_en.newPasswordPlaceholder = "wallet password";
        global_en.newPasswordRequired = "Wallet password is required";
        global_en.newPasswordLength = "The password must be at least 8 bits long";
        global_en.newPasswordConfirmPlaceholder = "wallet password";
        global_en.newPasswordConfirmRequired = "Password confirm is required";
        global_en.newPasswordConfirmEqualto = "Password and confirm password do not match";
        global_en.importPrikeyInputPlaceholder = "WIF Format";
        global_en.importPrikeyInputRequired = "Private key is required";
        global_en.importPrikeyInputLength = "Private key must be a 52-bit Base58 encoding";
        global_en.inputMPlaceholder = "Minimum is 1";
        global_en.inputMRequired = "Minimum number of signatures is required";
        global_en.publicInputTplPlaceholder = "public key";
        global_en.publickeyitemPlaceholder = "public key";
        global_en.addPublicTitle = "add key";
        global_en.transferTxoutPlaceholder = "Other Neo address";
        global_en.transferValuePlaceholder = "value";
        global_en.inputDataPlaceholder = "Ready to sign Tx";
        global_en.inputAssetNamePlaceholder = "Enter the asset's name";
        global_en.inputAmountPlaceholder = "Enter the total assets";
        global_en.issueOutputAddrPlaceholder = "address";
        global_en.issueOutputValuePlaceholder = "value";
        global_en.inputAntcoinPlaceholder = "Enter number of ANC guarantee";
        global_en.relayDataPlaceholder = "Broadcast packets";
        global_en.addInputTitle = "add input";
        global_en.accountAlreadyExits = "The Account had been imported";
        global_en.theAntsharesSystem = "The Neo System";
        global_en.transferTxoutRequired = "Other Neo address is required";
        global_en.transferValueRequired = "Transfer value is required";
        global_en.transferAssetRequired = "Transfer asset is required";
        global_en.assetNameRequired = "Asset name is required";
        global_en.assetAmountRequired = "Asset amount is required";
        global_en.issueAssetsRequired = "Issue asset is required";
        global_en.relayDataRequired = "Broadcast packets is required";
        global_en.inputDataRequired = "Ready to sign Tx is required";
        global_en.issuer = "issuer: ";
        global_en.issuerPubKey = "issuer public key: ";
        global_en.unConfirmed = "unconfirmed";
        global_en.minerTx = "Miner";
        global_en.issueTx = "Issue";
        global_en.claimTx = "Claim";
        global_en.enrollmentTx = "Enrollment";
        global_en.registerTx = "Registration";
        global_en.contractTx = "Contract";
        global_en.agencyTx = "Agency";
        global_en.publishTx = "Publish";
        global_en.noTxs = "You have no transactions yet";
        global_en.RPCError = "Sorry, we have some problems here, cannot create wallets now, please try again later.";
        global_en.txId = "Transaction has been made, please wait for confirmations, txid: ";
        global_en.addressError = "Improper Address";
        global_en.contactAddressRequired = "Address is required";
        global_en.contactNameRequired = "Name is required";
        global_en.contactNameLength = "The name must be at least 20 bits long";
        global_en.contactAddressRegex = "Incorrect address format";
        global_en.contactNameRegex = "Incorrect neme format";
        global_en.transferTxoutRegex = "Incorrect address format";
        global_en.privateIsWrong = "Incorrect private key format";
        global_en.pleaseChooseAsset = "Please choose asset.";
        global_en.createWallet = "Create Wallet";
        global_en.pleaseWait = "Please Wait...";
        global_en.importPrikey = "Import private key";
        global_en.transferValueRegex = "Incorrect value";
        global_en.browserIndexedb = "IndexedDB is not supported in this browser, please dowanload Neo App in Appstore.";
        global_en.browserError = "This wallet cannot be used in embedded browser, please dowanload Neo App in Appstore.";
        global_en.contactExists = "Contact already exists.";
        global_en.showReceiveAddress = "Good job, Now you can click 'receive' and see receive address.";
        global_en.netError = "Internet Error!";
        global_en.antshareIntegerOnly = "Integer only for Neo";
        global_en.gesturePwdWrong = "Drawn twice does not match the pattern, please try again.";
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
        ...
        (function (Wallet) {
            var Backup = (function (_super) {
                ...
                function Backup() {
                    ...
                    _this.OnWebBackupClick = function () {
                        try {
                            _this.loadFile().then(function (array) {
                                var strDb = JSON.stringify(array);
                                var db = [strDb];
                                var blob = new Blob(db, { "type": "application/octet-binary" });
                    ...
                    _this.OnAppBackupClick = function () {
                        try {
                            _this.loadFile().then(function (array) {
                                noResume = true;
                                var strDb = JSON.stringify(array);
                                var dataUrl = "data:text/json;base64," + window.btoa(strDb);
                                var db = [strDb];
                                var blob = new Blob(db, { "type": "text/json" });
                                var url = URL.createObjectURL(blob);
                                window.plugins.socialsharing.share('wallet file', 'Your wallet', dataUrl);
                                _this.showHasBackup();
                            }).catch(function (e) {
                                console.log(e);
                            });
                    ...
                    _this.OnHasBackupClick = function () {
                        var backup = getCookie("hasBackup");
                        if (backup == "" || backup == "0") {
                            setCookie("hasBackup", "1", 365);
                            $("#hasbackup_div").hide();
                            alert(UI.Resources.global.showReceiveAddress);
                        }
                    };
                    _this.loadFile = function () {
                        ...
                        wallet.content = { name: AntShares.Global.Wallet.dbPath };
                        var _transaction = _this.db.transaction(["Key", "Contract", "Coin", "Account", "Transaction"], "readonly");
                        var arrayKey = new Array();
                        _transaction.store("Key").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                        ...
                        _transaction.store("Contract").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                        ...
                        var arrayCoin = new Array();
                        _transaction.store("Coin").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                        ...
                        _transaction.store("Account").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                        ...
                        var arrayTransaction = new Array();
                        _transaction.store("Transaction").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                        ...
                        return _transaction.commit().then(function () {
                ...
                Backup.prototype.oncreate = function () {
                ...
                Backup.prototype.onload = function (args) {
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    setTitle(0);
                    ...
                    if (AntShares.Global.Wallet == null) {
                        ...
                        back.show();
                    this.db = new AntShares.Implementations.Wallets.IndexedDB.WalletDataContext(AntShares.Global.Wallet.dbPath);
                    this.db.open();
                    if (isMobileApp.App()) {
                ...
                Backup.prototype.showHasBackup = function () {
                    var backup = getCookie("hasBackup");
                    if (backup == "" || backup == "0") {
                        setTimeout(function () { $("#hasbackup_div").show('fast'); }, 1000);
                    }
                };
                return Backup;
            }(UI.TabBase));
            Wallet.Backup = Backup;
        })(Wallet = UI.Wallet || (UI.Wallet = {}));
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
        ...
        (function (Wallet) {
            var ChangePassword = (function (_super) {
                ...
                function ChangePassword() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnChangePasswordButtonClick = function () {
                        if (formIsValid("form_change_password")) {
                            AntShares.Global.Wallet.changePassword($("#old_password").val(), $("#new_password").val()).then(function (result) {
                                if (result) {
                                    $("#change_error").hide();
                                    formReset("form_change_password");
                                    alert(UI.Resources.global.changePwdSuccess);
                                    UI.TabBase.showTab("#Tab_Account_Index");
                                }
                                else {
                                    $("#change_error").show();
                                }
                ...
                ChangePassword.prototype.oncreate = function () {
                ...
                ChangePassword.prototype.onload = function () {
                    ...
                    setTitle(0);
                    $("#change_wallet_name").text(AntShares.Global.Wallet.dbPath);
                };
        ...
        (function (Wallet) {
            var Create = (function (_super) {
                ...
                function Create() {
                    ...
                    _this.OnCreateButtonClick = function () {
                        if (formIsValid("form_create_wallet")) {
                            if ($("#create_wallet").text() == UI.Resources.global.pleaseWait) {
                                console.log("重复点击");
                                return;
                            }
                            $("#create_wallet").text(UI.Resources.global.pleaseWait);
                            setTimeout(function () { _this.CreateRun(); }, 100);
                        }
                    };
                    return _this;
                }
                ...
                Create.prototype.onload = function () {
                    setTitle(0);
                    $("#create_wallet").text(UI.Resources.global.createWallet);
                    $("#wallet_name").val("wallet");
                };
                Create.prototype.CreateRun = function () {
                    var name = "wallet";
                    if (AntShares.Global.isConnected == false) {
                        alert(UI.Resources.global.RPCError);
                        $("#create_wallet").text(UI.Resources.global.createWallet);
                        return;
                    }
                    var master;
                    AntShares.Wallets.Master.instance().then(function (result) {
                        master = result;
                        return master.get();
                    }).then(function (result) {
                        if (result.indexOf(name) >= 0)
                            throw new Error(UI.Resources.global.sameWalletName);
                        return AntShares.Implementations.Wallets.IndexedDB.IndexedDBWallet.create(name, $("#create_password").val());
                    }).then(function (wallet) {
                        AntShares.Global.Wallet = wallet;
                        ...
                        UI.TabBase.showTab("#Tab_Wallet_Backup", true);
                    }, function (reason) {
                        alert(reason);
                        $("#create_wallet").text(UI.Resources.global.createWallet);
                    });
...
(function (AntShares) {
    ...
    (function (UI) {
        var Wallet;
        (function (Wallet) {
            var GesturePassword = (function (_super) {
                __extends(GesturePassword, _super);
                function GesturePassword() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                GesturePassword.prototype.oncreate = function () {
                    $("#Tab_Wallet_GesturePassword #gesturepwdSet").GesturePasswd({
                ...
                GesturePassword.prototype.onload = function () {
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    ...
                    var cnt = 0;
                    var effective = 0;
                    $("#Tab_Wallet_GesturePassword #gesturepwdSet").on("hasPasswd", function (e, passwd) {
                        if (cnt == 0) {
                            initPwd = passwd;
                            cnt++;
                            ...
                            if (initPwd == confirmPwd) {
                                ...
                                alert(UI.Resources.global.gesturePwdWrong);
                            }
                        }
                    });
                };
            ...
            Wallet.GesturePassword = GesturePassword;
        })(Wallet = UI.Wallet || (UI.Wallet = {}));
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
    ...
    (function (UI) {
        ...
        (function (Wallet) {
            var Import = (function (_super) {
                ...
                function Import() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnImportButtonClick = function () {
                        if (formIsValid("form_account_import")) {
                            if ($("#import_prikey").text() == UI.Resources.global.pleaseWait) {
                                console.log("重复点击");
                                return;
                            }
                            $("#import_prikey").text(UI.Resources.global.pleaseWait);
                            setTimeout(function () { _this.ImportRun(); }, 100);
                        }
                    };
                    return _this;
                }
                Import.prototype.oncreate = function () {
                    $(this.target).find("#import_prikey").click(this.OnImportButtonClick);
                };
                Import.prototype.onload = function () {
                    setTitle(0);
                    $("#import_prikey").text(UI.Resources.global.importPrikey);
                    formReset("form_account_import");
                };
                Import.prototype.ImportRun = function () {
                    var wifPrivateKey = $("#import_prikey_input").val();
                    var account;
                    var name = "wallet";
                    Promise.resolve(1).then(function () {
                        try {
                            ...
                            $("#import_prikey").text(UI.Resources.global.importPrikey);
                            throw new Error(UI.Resources.global.privateIsWrong);
                        }
                    }).then(function (result) {
                        ...
                        if ($("#remote_height").text() == "0") {
                            $("#import_prikey").text(UI.Resources.global.importPrikey);
                            throw new Error(UI.Resources.global.RPCError);
                        }
                        return AntShares.Implementations.Wallets.IndexedDB.IndexedDBWallet.create(name, $("#import_password").val(), false);
                    }).then(function (wallet) {
                        AntShares.Global.Wallet = wallet;
                        return AntShares.Wallets.Master.instance();
                    }).then(function (master) {
                        return master.add(name);
                    }).then(function (results) {
                        var accounts = AntShares.Global.Wallet.getAccounts();
                        var wifPublicKeyHash = account.publicKeyHash.toString();
                        for (var i = 0; i < accounts.length; i++) {
                            if (wifPublicKeyHash == accounts[i].publicKeyHash.toString()) {
                                $("#import_prikey").text(UI.Resources.global.importPrikey);
                                throw new Error(UI.Resources.global.accountAlreadyExits);
                            }
                        }
                        return AntShares.Global.Wallet.import(wifPrivateKey);
                    }).then(function (result) {
                        alert(UI.Resources.global.importAccountAlert);
                        return AntShares.Global.Wallet.rebuild();
                    }).then(function () {
                        $("#import_prikey").text(UI.Resources.global.importPrikey);
                        $("footer").show();
                        $(".menu-progress").show();
    ...
    (function (UI) {
        ...
        (function (Wallet) {
            var Open = (function (_super) {
                ...
                function Open() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnOpenButtonClick = function () {
                        if (formIsValid("form_open_wallet")) {
                            var name_1 = $('#list_wallet_name').val();
                            AntShares.Implementations.Wallets.IndexedDB.IndexedDBWallet.open(name_1, $("#open_password").val()).then(function (result) {
                                if (!result) {
                                    $("#open_error").show();
                                    return;
                                }
                                AntShares.Global.Wallet = result;
                                ...
                                $(".camera").show();
                                UI.TabBase.showTab("#Tab_Account_Index");
                            }, function (reason) { return $("#open_error").show(); });
                        }
                    };
                    return _this;
                }
                Open.prototype.oncreate = function () {
                    $(this.target).find("button").click(this.OnOpenButtonClick);
                };
                Open.prototype.onload = function (args) {
                    setTitle(0);
                    $(".camera").hide();
                    if (args[0]) {
                        $("#gesture_pwd_tips").show();
                    }
                    if (AntShares.Global.isDebug) {
                        $("#developer_tool").show();
                        $("#debug_log").show();
                    }
                    else {
                ...
                Open.listWallet = function (walletNameList) {
                    if (walletNameList.length == 0) {
                        UI.TabBase.showTab("#Tab_Wallet_Start");
                        $("#menu_wallet_open").hide();
                        $("footer").hide();
                    }
                    else {
        ...
        (function (Wallet_1) {
            var Restore = (function (_super) {
                ...
                function Restore() {
                        ...
                        window.requestFileSystem(window.PERSISTENT, 0, function (fs) {
                            ...
                            directoryReader.readEntries(function (entries) {
                                ...
                                var _loop_4 = function (i) {
                                    var row = entries[i];
                                    if (row.isFile) {
                                        var ul = $("#Tab_Wallet_Restore").find("ul:eq(0)");
                                        var liTemp = ul.find("li:eq(0)");
                                        var li_1 = liTemp.clone(true);
                                        li_1.removeAttr("style");
                                        li_1.click(function () {
                                            $("#restore_name_selected").val(row.name);
                                            $("#Tab_Wallet_Restore li").removeClass("info");
                                            $("#Tab_Wallet_Restore .restore-action").hide();
                                            li_1.addClass("info");
                                            li_1.find(".restore-action").show();
                                        });
                                        li_1.find(".btn-restore").click(_this.OnRestoreClick);
                                        li_1.addClass("add");
                                        li_1.find(".restore-name").text(row.name);
                                        ul.append(li_1);
                                        cntFiles++;
                                    }
                                };
                    ...
                    _this.OnRestoreClick = function () {
                        var name = $("#Tab_Wallet_Restore #restore_name_selected").val();
                        window.resolveLocalFileSystemURI('cdvfile://localhost/persistent/' + name, function (fileEntry) {
                    ...
                    _this.RestoreAction = function () {
                        ...
                        reader.onload = function () {
                            Restore.Restore(JSON.parse(this.result)).then(function () {
                ...
                Restore.prototype.oncreate = function () {
                    $(this.target).find("#files").on('change', this.RestoreAction);
                };
                Restore.prototype.onload = function (args) {
                    setTitle(0);
                    if (args[0])
                        $("#danger").show();
                    if (isMobileApp.App()) {
                ...
                Restore.prototype.readFile = function (fileEntry) {
            ...
            Restore.Restore = function (pJsonArray) {
                var master;
                var db;
                var _transaction;
                var Wallet;
                ...
                return Promise.resolve(1).then(function () {
                    ...
                    for (var i = 0; i < array.length; i++) {
                        switch (array[i]["table"]) {
                            case "Wallet":
                                Wallet = array[i]["content"];
                                break;
                            case "Key":
                                Key = array[i]["content"];
                                break;
                            case "Contract":
                                Contract = array[i]["content"];
                                break;
                            case "Coin":
                                Coin = array[i]["content"];
                                break;
                            case "Account":
                                Account = array[i]["content"];
                                break;
                            case "Transaction":
                                Transaction = array[i]["content"];
                                break;
                            default:
                                throw new Error(UI.Resources.global.walletJsonError);
                        }
                    }
                }, function (onreject) {
                    throw new Error(UI.Resources.global.walletJsonError);
                    ...
                    if (result.indexOf(Wallet["name"]) >= 0)
                        throw new Error(UI.Resources.global.sameWalletName1);
    ...
    (function (UI) {
        ...
        (function (Wallet) {
            var Validate = (function (_super) {
                ...
                Validate.prototype.oncreate = function () {
                    $("#gesturepwdValidate").GesturePasswd({
                        backgroundColor: "FFFFFF",
                        color: "#252736",
                        roundRadii: 25,
                        pointRadii: 6,
                ...
                Validate.prototype.onload = function (args) {
                    $('#menu').mmenu({ dragOpen: { open: false } });
                    $('footer').hide();
                    $('#icon_menu').hide();
                    setTitle(3);
                    var effective = 0;
...
(function (AntShares) {
    ...
    (function (UI) {
        var Contract;
        (function (Contract) {
            var CreateMultiSig = (function (_super) {
                __extends(CreateMultiSig, _super);
                function CreateMultiSig() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnCreateButtonClick = function () {
                        if (formIsValid("form_create_multisig")) {
                            var publicKeys_1 = new Array();
                            var _m = $("#input_m").val();
                            var m_1 = Number(_m.split(",").join(""));
                            var promises = new Array();
                            try {
                                var publicItems = $(".publickeyitem");
                                for (var i = 0; i < publicItems.length; i++) {
                                    if ($(publicItems[i]).val() != "") {
                                        var publickey = $(publicItems[i]).val();
                                        if (typeof publickey === "string") {
                                            publicKeys_1.push(AntShares.Cryptography.ECPoint.decodePoint(publickey.hexToBytes(), AntShares.Cryptography.ECCurve.secp256r1));
                                        }
                                    }
                                }
                                for (var i = 0; i < publicKeys_1.length; i++) {
                                    promises.push(publicKeys_1[i].encodePoint(true).toScriptHash());
                                }
                            }
                            catch (e) {
                                alert(e);
                            ...
                            Promise.all(promises).then(function (results) {
                                for (var i = 0; i < results.length; i++)
                                    if (AntShares.Global.Wallet.containsAccount(results[i]))
                                        return results[i];
                                throw new Error();
                            }).then(function (result) {
                                return AntShares.Wallets.Contract.createMultiSigContract(result, m_1, publicKeys_1);
                            }).then(function (result) {
                                return AntShares.Global.Wallet.addContract(result);
                            }).then(function () {
                                $("#Tab_Contract_CreateMultiSig .add_new").remove();
                                formReset("form_create_multisig");
                                alert(UI.Resources.global.createMultiContractSuccess);
                                UI.TabBase.showTab("#Tab_Contract_Index");
                            }).catch(function (reason) {
                                alert(reason);
                            });
                        }
                    };
                    _this.OnAddPublicKeyButtonClick = function () {
                        var parent = $("#Tab_Contract_CreateMultiSig #div_publickeys");
                        var inputElement = $("#Tab_Contract_CreateMultiSig #public_tpl").clone(true);
                        inputElement.show();
                ...
                CreateMultiSig.prototype.oncreate = function () {
                ...
                CreateMultiSig.prototype.onload = function (args) {
                };
                CreateMultiSig.prototype.removeInput = function (parent, divId) {
                    parent.find("#" + divId).remove();
                };
                return CreateMultiSig;
            }(UI.TabBase));
            Contract.CreateMultiSig = CreateMultiSig;
        })(Contract = UI.Contract || (UI.Contract = {}));
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
    ...
    (function (UI) {
        ...
        (function (Contract) {
            var Details = (function (_super) {
                ...
                Details.prototype.oncreate = function () {
                };
                Details.prototype.onload = function (args) {
                    var contract = args[0];
                    ...
                    contract.getAddress().then(function (result) {
    ...
    (function (UI) {
        ...
        (function (Contract) {
            var Index = (function (_super) {
                ...
                Index.prototype.oncreate = function () {
                };
                Index.prototype.onload = function () {
                    ...
                    $("#contract_list_wallet").text(AntShares.Global.Wallet.dbPath);
                    var ul = $("#Tab_Contract_Index #form_contract_list").find("ul:eq(0)");
                    ul.find("li:visible").remove();
                    var contracts = AntShares.Global.Wallet.getContracts();
                    for (var i = 0; i < contracts.length; i++)
                        if (!contracts[i].isStandard())
                            this.addContractList(contracts[i]);
                };
                Index.prototype.addContractList = function (contract) {
                    var ul = $("#form_contract_list").find("ul:eq(0)");
                    var liTemplet = ul.find("li:eq(0)");
                    var li = liTemplet.clone(true);
                    li.removeAttr("style");
                    var spanAddress = li.find("span:eq(0)");
                    var a = li.find("a");
                    a.click(function () {
                        UI.TabBase.showTab("#Tab_Contract_Details", contract);
                    });
                    contract.getAddress().then(function (result) {
        ...
        (function (Contacts) {
            var Contact = (function (_super) {
                ...
                Contact.prototype.add = function (name, address) {
                    return AntShares.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Contacts", "readwrite").store("Contacts").put({ name: name, address: address }));
                };
                Contact.prototype.clear = function () {
                    return AntShares.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Contacts", "readwrite").store("Contacts").clear());
                };
                Contact.prototype.delete = function (name) {
                    return AntShares.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Contacts", "readwrite").store("Contacts").delete(name));
                };
                ...
                function Create() {
                    ...
                    _this.OnCreateClick = function () {
                        if (formIsValid("form_create_contact")) {
                            var name_2 = $("#contact_name").val();
                            var address_1 = $("#contact_address").val();
                            var contacts_1;
                            Contacts.Contact.instance().then(function (result) {
                                contacts_1 = result;
                                return contacts_1.get();
                            }).then(function (result) {
                                if (result.indexOf(name_2) >= 0)
                                    throw new Error(UI.Resources.global.contactExists);
                                return contacts_1.add(name_2, address_1);
                            }).then(function (wallet) {
                                formReset("form_create_contact");
                                UI.TabBase.showTab("#Tab_Contacts_Index", true);
                            }).catch(function (e) {
                                alert(e);
                            });
                        }
    ...
    (function (UI) {
        ...
        (function (Contacts) {
            var Index = (function (_super) {
                ...
                function Index() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.loadContactsList = function () {
                        var contacts;
                        Contacts.Contact.instance().then(function (result) {
                            contacts = result;
                            ...
                            if (results.length == 0) {
                                ...
                                var contactsArray = linq(results).orderByDescending(function (p) { return p.name; }).toArray();
                                var result = Promise.resolve();
                                var _loop_5 = function (i) {
                                    var ul = $("#Tab_Contacts_Index").find("ul:eq(0)");
                                    var liTemp = ul.find("li:eq(0)");
                                    ...
                                    li.find(".btn-send").click(_this.OnSendClick);
                                    li.addClass("add");
                ...
                Index.prototype.OnDeleteClick = function () {
                    var modal = $('#deleteModal');
                    modal.modal('hide');
                    var name = $("#contact_name_selected").val();
                    var contacts;
                    Contacts.Contact.instance().then(function (result) {
                        contacts = result;
                        return contacts.get();
                        ...
                        UI.TabBase.showTab("#Tab_Contacts_Index");
                    }).catch(function (e) {
                        alert(e);
                    });
                };
                Index.prototype.OnSendClick = function () {
                    var address = $("#contact_address_selected").val();
                    UI.TabBase.showTab("#Tab_Account_Send", address);
                };
                return Index;
            }(UI.TabBase));
...
(function (AntShares) {
    ...
    (function (UI) {
        var Advanced;
        (function (Advanced) {
            var DebugLog = (function (_super) {
                __extends(DebugLog, _super);
                function DebugLog() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnDebugClick1 = function (str) {
                        if (AntShares.Global.isMainNet == true) {
                            debugLog("主网2.4");
                        }
                        else {
                            debugLog("测试网2.4");
                ...
                DebugLog.prototype.oncreate = function () {
                    $(this.target).find("#debug1").click(this.OnDebugClick1);
                };
                DebugLog.prototype.onload = function (args) {
                };
                return DebugLog;
            }(UI.TabBase));
            Advanced.DebugLog = DebugLog;
        })(Advanced = UI.Advanced || (UI.Advanced = {}));
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
    ...
    (function (UI) {
        var Advanced;
        (function (Advanced) {
            var DeveloperTool = (function (_super) {
                __extends(DeveloperTool, _super);
                function DeveloperTool() {
                    ...
                    _this.OnDeleteButtonClick = function () {
                        ...
                        AntShares.Wallets.Master.instance().then(function (result) {
                            ...
                            master = result;
                            if (AntShares.Global.Wallet != null) {
                                return AntShares.Global.Wallet.close();
                            }
                        }).then(function () {
                            AntShares.Global.Wallet = null;
                            return master.get();
                            ...
                            for (var j = 0; j < result.length; j++) {
                                promises[j + 1] = promises[j].then(AntShares.Implementations.Wallets.IndexedDB.IndexedDBWallet.delete(result[j]));
                            }
                            ;
                            return Promise.all(promises);
                        }).then(function () {
                            ...
                            return AntShares.Implementations.Wallets.IndexedDB.DbContext.delete("master");
                        }).then(function () {
                    ...
                    _this.OnSetHeightButtonClick = function () {
                        var height = $("#Tab_Advanced_DeveloperTool #input_curent_height").val();
                        AntShares.Global.Blockchain.getBlockCount().then(function (result) {
                            var currentHeight = result - 1;
                            var value = new Uint32Array([height]).buffer;
                            if (height < 0 || height > currentHeight) {
                                alert("输入值有误！");
                            }
                            else {
                                var _transaction = _this.db.transaction("Key", "readwrite");
                                _transaction.store("Key").put({
                                    name: "Height",
                                    value: new Uint8Array(value).toHexString()
                                });
                    ...
                    _this.OnRefreshNode = function () {
                        $("#seed").text(AntShares.Global.RpcClient.Url);
                    };
                    _this.OnRefreshDevice = function () {
                        $("#platform").text(device.platform);
                        $("#version").text(device.version);
                    };
                    return _this;
                }
                DeveloperTool.prototype.oncreate = function () {
                ...
                DeveloperTool.prototype.onload = function (args) {
                    try {
                        this.db = new AntShares.Implementations.Wallets.IndexedDB.WalletDataContext(AntShares.Global.Wallet.dbPath);
                        this.db.open();
                    }
                ...
                DeveloperTool.prototype.showPrivateKey = function () {
                    var accounts = AntShares.Global.Wallet.getAccounts();
                    var str = "";
                    for (var i = 0; i < accounts.length; i++) {
                        accounts[i].export().then(function (result) {
                            str = str + result + "\r\n";
                            $("#pri_key").text(str);
                        });
                    }
                };
                DeveloperTool.prototype.OnNoBackupButtonClick = function () {
                    var backup = getCookie("hasBackup");
                    setCookie("hasBackup", "0", 365);
                    UI.TabBase.showTab("#Tab_Account_Receive");
                };
                return DeveloperTool;
            }(UI.TabBase));
            Advanced.DeveloperTool = DeveloperTool;
        })(Advanced = UI.Advanced || (UI.Advanced = {}));
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
(function (AntShares) {
    ...
    (function (UI) {
        var Advanced;
        (function (Advanced) {
            var Elect = (function (_super) {
                __extends(Elect, _super);
                function Elect() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnElectButtonClick = function () {
                        var value = $("#Tab_Advanced_Elect #input_antcoin").val();
                        var validator = $("#Tab_Advanced_Elect #select_validator").find("option:selected").text();
                        try {
                            var publicKey = AntShares.Cryptography.ECPoint.decodePoint(validator.hexToBytes(), AntShares.Cryptography.ECCurve.secp256r1);
                            var scriptHash = new AntShares.Uint160(AntShares.Wallets.Contract.createSignatureRedeemScript(publicKey));
                            var tx = new AntShares.Core.EnrollmentTransaction();
                            tx.publicKey = publicKey;
                            tx.outputs = [new AntShares.Core.TransactionOutput()];
                            tx.outputs[0].assetId = AntShares.Core.Blockchain.AntCoin.hash;
                            tx.outputs[0].value = AntShares.Fixed8.parse(value);
                            tx.outputs[0].scriptHash = scriptHash;
                            var _tx = AntShares.Global.Wallet.makeTransaction(tx, AntShares.Fixed8.Zero);
                            return _this.SignAndShowInformation(_tx);
                        }
                        catch (e) {
                            if (e instanceof SyntaxError) {
                                alert(UI.Resources.global.dataFormatError);
                            }
                            else {
                                alert(e);
                            }
                    ...
                    _this.SignAndShowInformation = function (tx) {
                        var context;
                        if (tx == null) {
                            throw new Error(UI.Resources.global.insufficientFunds);
                        }
                        return AntShares.Core.SignatureContext.create(tx, "AntShares.Core." + AntShares.Core.TransactionType[tx.type]).then(function (ct) {
                            context = ct;
                            return AntShares.Global.Wallet.sign(ct);
                        }).then(function (result) {
                            if (!result)
                                throw new Error(UI.Resources.global.canNotSign);
                            if (!context.isCompleted())
                                throw new Error(UI.Resources.global.thisVersion1);
                            tx.scripts = context.getScripts();
                            return AntShares.Global.Wallet.saveTransaction(tx);
                        }).then(function (result) {
                            if (!result)
                                throw new Error(UI.Resources.global.txError1);
                            return AntShares.Global.Node.relay(tx);
                        }).then(function (result) {
                            UI.TabBase.showTab("#Tab_Asset_Index");
                            alert(UI.Resources.global.electionInfo);
                        }).catch(function (reason) {
                            alert(reason);
                        });
                    };
                ...
                Elect.prototype.oncreate = function () {
                    $(this.target).find("#elect").click(this.OnElectButtonClick);
                };
                Elect.prototype.onload = function (args) {
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    $("#Tab_Advanced_Elect #select_validator").empty();
                    var validatorArray = linq(AntShares.Global.Wallet.getAccounts()).select(function (p) { return p.publicKey; }).toArray();
    ...
    (function (UI) {
        ...
        (function (Advanced) {
            var Issue = (function (_super) {
                ...
                function Issue() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.rtx = new AntShares.Core.RegisterTransaction();
                    _this.OnIssueAssetChanged = function () {
                        var assetName = $("#Tab_Advanced_Issue #select_issue_assets").find("option[value=0]").text();
                        AntShares.Global.Wallet.getTransactions(AntShares.Core.TransactionType.RegisterTransaction).then(function (issueAssets) {
                            var assetName = $("#Tab_Advanced_Issue #select_issue_assets").find("option:selected").text();
                            var _loop_6 = function (i) {
                                var tx = issueAssets[i];
                                if (assetName == tx.getName()) {
                                    _this.rtx = tx;
                                    $("#Tab_Advanced_Issue .issue_info").show();
                                    var parent_1 = $("#Tab_Advanced_Issue #issue_infos");
                                    parent_1.empty();
                                    var div_1 = new Array();
                                    div_1.push($("<div>" + UI.Resources.global.publisher + "：" + tx.issuer + "</div>"));
                                    div_1.push($("<div>" + UI.Resources.global.admin + "：" + tx.admin + "</div>"));
                                    var tAmount = tx.amount.equals(AntShares.Fixed8.MaxValue) ? "∞" : tx.amount.toString();
                                    div_1.push($("<div>" + UI.Resources.global.amount + "：" + tAmount + "</div>"));
                                    div_1.forEach(function () { parent_1.append(div_1); });
                                }
                            };
                            for (var i = 0; i < issueAssets.length; i++) {
                                _loop_6(i);
                            }
                        });
                    };
                    _this.OnIssueButtonClick = function () {
                        if (formIsValid("form_issue")) {
                            var itx_1 = new AntShares.Core.IssueTransaction();
                            var outputs_1 = new Array();
                            var promises = new Array();
                            var issueOutputs_1 = $("#Tab_Advanced_Issue .issue_output");
                            var _loop_7 = function (i) {
                                if ($(issueOutputs_1[i]).val() == "" || $(issueOutputs_1[i + 1]).val() == "") {
                                    return "continue";
                                }
                                else {
                                    promises.push(AntShares.Wallets.Wallet.toScriptHash($(issueOutputs_1[i]).val()).then(function (result) {
                                        return { address: result, value: AntShares.Fixed8.fromNumber($(issueOutputs_1[i + 1]).val()), assetid: _this.rtx.hash };
                                    }));
                                }
                            };
                            for (var i = 0; i < issueOutputs_1.length; i = i + 2) {
                                _loop_7(i);
                            }
                            Promise.all(promises).then(function (results) {
                                results.forEach(function (result) {
                                    var _output = new AntShares.Core.TransactionOutput();
                                    _output.assetId = result.assetid;
                                    _output.scriptHash = result.address;
                                    _output.value = result.value;
                                    outputs_1.push(_output);
                                });
                                itx_1.outputs = outputs_1;
                                var _tx = AntShares.Global.Wallet.makeTransaction(itx_1, AntShares.Fixed8.Zero);
                                return _this.SignAndShowInformation(_tx);
                            }).catch(function (reason) {
                                alert(reason);
                            });
                    ...
                    _this.SignAndShowInformation = function (tx) {
                        ...
                        return AntShares.Core.SignatureContext.create(tx, "AntShares.Core." + AntShares.Core.TransactionType[tx.type]).then(function (ct) {
                            ...
                            UI.TabBase.showTab("#Tab_Asset_Index");
                            alert(UI.Resources.global.issueInfo);
                        }).catch(function (reason) {
                            alert(reason);
                        });
                    };
                ...
                Issue.prototype.onload = function (args) {
                    ...
                    AntShares.Global.Wallet.getTransactions(AntShares.Core.TransactionType.RegisterTransaction).then(function (issueAssets) {
                        $("#Tab_Advanced_Issue #select_issue_assets").append("<option value=0>" + UI.Resources.global.pleaseChoose + "</option>");
                        for (var i = 0; i < issueAssets.length; i++) {
                            var tx = issueAssets[i];
                ...
                Issue.prototype.removeInput = function (parent, divId) {
                    parent.find("#" + divId).remove();
                };
                Issue.prototype.OnAddInputClick = function () {
                    var parent = $("#Tab_Advanced_Issue #issue_outputs");
                    var inputElement = $("#Tab_Advanced_Issue #issue_tpl").clone(true);
                    inputElement.show();
                    inputElement.removeAttr("id");
                    parent.append(inputElement);
                };
    ...
    (function (UI) {
        ...
        (function (Advanced) {
            var Register = (function (_super) {
                ...
                function Register() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnCheckLimitChanged = function () {
                        if ($("#check_limit").prop('checked') == true) {
                            $("#input_amount").val(_this.inputAmountTemp);
                            $("#input_amount").prop('disabled', false);
                        }
                        else {
                            _this.inputAmountTemp = $("#input_amount").val();
                            $("#input_amount").val("∞");
                            $("#input_amount").prop('disabled', true);
                        }
                    };
                    _this.OnRegisterAssetChanged = function () {
                        var assetType = $("#Tab_Advanced_Register #select_register_asset").val();
                    ...
                    _this.OnRegisterButtonClick = function () {
                        if (formIsValid("form_register_asset")) {
                            var _assetTotalAmount = $("#Tab_Advanced_Register #input_amount").val();
                            var assetTotalAmount = Number(_assetTotalAmount.split(",").join(""));
                            var _assetName = $("#Tab_Advanced_Register #input_asset_name").val();
                            var assetName = '[{ "lang": "zh-CN", "name": " ' + _assetName + ' "}]';
                            var assetType = $("#Tab_Advanced_Register #select_register_asset").find("option:selected").text();
                            var issuer_1 = $("#Tab_Advanced_Register #select_issuer").find("option:selected").text();
                            var admin = $("#Tab_Advanced_Register #select_admin").find("option:selected").text();
                            try {
                                var tx_1 = new AntShares.Core.RegisterTransaction();
                                tx_1.assetType = AntShares.Core.AssetType[assetType];
                                if (tx_1.assetType == null) {
                                    throw Error(UI.Resources.global.selectAssetType);
                                }
                                tx_1.name = assetName;
                                tx_1.amount = $("#Tab_Advanced_Register #check_limit").prop('checked') == true ? AntShares.Fixed8.fromNumber(assetTotalAmount) : AntShares.Fixed8.MaxValue;
                                tx_1.outputs = new Array(0);
                                tx_1.precision = 0;
                                AntShares.Wallets.Wallet.toScriptHash(admin).then(function (result) {
                                    tx_1.issuer = AntShares.Cryptography.ECPoint.decodePoint(issuer_1.hexToBytes(), AntShares.Cryptography.ECCurve.secp256r1);
                                    tx_1.admin = result;
                                    var _tx = AntShares.Global.Wallet.makeTransaction(tx_1, AntShares.Fixed8.Zero);
                                    return _this.SignAndShowInformation(_tx);
                                }).catch(function (reason) {
                                    alert(reason);
                                });
                    ...
                    _this.SignAndShowInformation = function (tx) {
                        ...
                        return AntShares.Core.SignatureContext.create(tx, "AntShares.Core." + AntShares.Core.TransactionType[tx.type]).then(function (ct) {
                            ...
                            UI.TabBase.showTab("#Tab_Asset_Index");
                            alert(UI.Resources.global.registInfo + tx.hash.toString());
                        }).catch(function (reason) {
                            alert(reason);
                        });
                    };
                ...
                Register.prototype.oncreate = function () {
                    ...
                    $("#select_register_asset").append("<option value=0>" + UI.Resources.global.pleaseChoose + "</option>");
                    $("#select_register_asset").append("<option value=1>" + AntShares.Core.AssetType[AntShares.Core.AssetType.Share] + "</option>");
                    $("#select_register_asset").append("<option value=2>" + AntShares.Core.AssetType[AntShares.Core.AssetType.Token] + "</option>");
                    $("#select_register_asset").change(this.OnRegisterAssetChanged);
                    $("#check_limit").change(this.OnCheckLimitChanged);
                };
                Register.prototype.onload = function (args) {
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    formReset("form_register_asset");
                    var issuerArray = linq(AntShares.Global.Wallet.getAccounts()).select(function (p) { return p.publicKey; }).toArray();
                    Promise.all(linq(AntShares.Global.Wallet.getContracts()).select(function (p) { return p.getAddress(); }).toArray()).then(function (adminArray) {
                        for (var i = 0; i < issuerArray.length; i++) {
...
(function (AntShares) {
    ...
    (function (UI) {
        var Advanced;
        (function (Advanced) {
            var RegisterAssetList = (function (_super) {
                __extends(RegisterAssetList, _super);
                function RegisterAssetList() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.loadRegisterAssetList = function () {
                        var _transaction = _this.db.transaction("Transaction", "readonly");
                        var arrayRegisterAsset = new Array();
                        _transaction.store("Transaction").index("type").openCursor(IDBKeyRange.only(AntShares.Core.TransactionType.RegisterTransaction)).onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                        ...
                        return _transaction.commit().then(function () {
                            if (arrayRegisterAsset.length <= 0) {
                                ...
                                arrayRegisterAsset.forEach(function (result) {
                                    var tbody = $("#Tab_Advanced_RegisterAssetList").find("tbody");
                                    var trTemplet = tbody.find("tr:eq(0)");
                                    var tr = trTemplet.clone(true);
                                    tr.removeAttr("style");
                                    var tx = AntShares.Core.Transaction.deserializeFrom(result.rawData.hexToBytes().buffer);
                                    return tx.ensureHash().then(function (result) {
                                        var asset = tx;
                ...
                RegisterAssetList.prototype.oncreate = function () {
                };
                RegisterAssetList.prototype.onload = function (args) {
                    var _this = this;
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    var ul = $("#Tab_Advanced_RegisterAssetList").find("ul:eq(0)");
                    this.db = new AntShares.Implementations.Wallets.IndexedDB.WalletDataContext(AntShares.Global.Wallet.dbPath);
                    this.db.open().then(function () {
                        _this.loadRegisterAssetList();
                    });
                };
                return RegisterAssetList;
            }(UI.TabBase));
            Advanced.RegisterAssetList = RegisterAssetList;
        })(Advanced = UI.Advanced || (UI.Advanced = {}));
    })(UI = AntShares.UI || (AntShares.UI = {}));
})(AntShares || (AntShares = {}));
var AntShares;
    ...
    (function (UI) {
        ...
        (function (Advanced) {
            var Relay = (function (_super) {
                ...
                function Relay() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnConvertButtonClick = function () {
                        if (formIsValid("form_relay_data")) {
                            var strRelayData = $("#Tab_Advanced_DeveloperTool #relay_data").val();
                            try {
                                if (strRelayData == "") {
                                    alert(UI.Resources.global.pleaseInputData);
                                }
                                else {
                                    AntShares.Core.SignatureContext.parse(strRelayData).then(function (context) {
                                        context.signable.setScripts(context.getScripts());
                                        var ms = new AntShares.IO.MemoryStream();
                                        var writer = new AntShares.IO.BinaryWriter(ms);
                                        context.signable.serialize(writer);
                                        var output = new Uint8Array(ms.toArray(), 0);
                    ...
                    _this.OnRelayButtonClick = function () {
                        if (formIsValid("form_relay_data")) {
                            var strRelayData = $("#Tab_Advanced_DeveloperTool #relay_data").val();
                            try {
                                if (strRelayData == "") {
                                    ...
                                    AntShares.Core.SignatureContext.parse(strRelayData).then(function (context) {
                                        context.signable.setScripts(context.getScripts());
                                        inventory_1 = context.signable;
                                        return AntShares.Global.Node.relay(inventory_1);
                                    }).then(function (success) {
                                        if (success) {
                                            alert(UI.Resources.global.relaySuccess);
                                        }
                                        else {
                                            alert(UI.Resources.global.relayFaild);
                                        }
                                    }).catch(function (reason) {
                                        alert(reason);
                                    });
    ...
    (function (UI) {
        ...
        (function (Advanced) {
            var Sign = (function (_super) {
                ...
                function Sign() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.onSignButtonClick = function () {
                        if (formIsValid("form_sign_data")) {
                            var inputData = $("#Tab_Advanced_Sign #input_data").val();
                            try {
                                var context_1;
                                AntShares.Core.SignatureContext.parse(inputData).then(function (result) {
                                    context_1 = result;
                                    return AntShares.Global.Wallet.sign(result);
                                }).then(function (success) {
                                    if (success) {
                                        $("#Tab_Advanced_Sign #output_section").removeAttr("style");
                                        $("#Tab_Advanced_Sign #output_data").text(context_1.toString());
                                        alert(UI.Resources.global.signFinish);
                                    }
                                    else {
                                        alert(UI.Resources.global.signError1);
                                    }
                                }).catch(function (reason) {
                                    alert(reason);
                                });
                    ...
                    _this.onSignRelayButtonClick = function () {
                        if (formIsValid("form_sign_data")) {
                            var inputData = $("#Tab_Advanced_Sign #input_data").val();
                            try {
                                var inventory_2;
                                ...
                                AntShares.Core.SignatureContext.parse(inputData).then(function (result) {
                                    ...
                                    if (success) {
                                        $("#Tab_Advanced_Sign #output_section").removeAttr("style");
                                        $("#Tab_Advanced_Sign #output_data").text(context_2.toString());
                                        context_2.signable.setScripts(context_2.getScripts());
                                        inventory_2 = context_2.signable;
                                        return AntShares.Global.Node.relay(inventory_2);
                                    }
                                    else {
                                        alert(UI.Resources.global.signError1);
                                    }
    ...
    (function (UI) {
        ...
        (function (Advanced) {
            var Vote = (function (_super) {
                ...
                function Vote() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnAddCandidatesButtonClick = function () {
                        var parent = $("#Tab_Advanced_Vote #div_candidates");
                        var inputElement = $("#Tab_Advanced_Vote #candidates_tpl").clone(true);
                        inputElement.show();
                        inputElement.addClass("add_new");
                        inputElement.removeAttr("id");
                        parent.append(inputElement);
                    };
                    _this.OnVoteButtonClick = function () {
                    };
                    _this.SignAndShowInformation = function (tx) {
                        var context;
                        if (tx == null) {
                        ...
                        return AntShares.Core.SignatureContext.create(tx, "AntShares.Core." + AntShares.Core.TransactionType[tx.type]).then(function (ct) {
                            ...
                            alert(UI.Resources.global.voteInfo);
                        }).catch(function (reason) {
                            alert(reason);
                        });
                    };
        ...
        (function (Account) {
            var Index = (function (_super) {
                ...
                function Index() {
                    ...
                    _this.OnShowMore = function () {
                        if ($("#asset_show_more").hasClass("rotate180")) {
                            ...
                            var otherAssetCount = $("#Tab_Account_Index").find("ul:eq(0)").find("li").length - 1;
                    ...
                    _this.loadTransactionList = function () {
                        var _transaction = _this.db.transaction("Transaction", "readonly");
                        var arrayTransaction = new Array();
                        var execute;
                        _transaction.store("Transaction").openCursor().onsuccess = function (e) {
                        ...
                        return _transaction.commit().then(function () {
                            if (arrayTransaction.length <= 0) {
                                ...
                                throw new Error(UI.Resources.global.noTxs);
                            }
                            else {
                                $("#Account_TransactionList .empty").hide();
                                $("#Account_TransactionList .title").show();
                                var txArray_1 = linq(arrayTransaction).orderByDescending(function (p) { return p.time; }).toArray();
                                var result_1 = Promise.resolve();
                                execute = function () {
                                    var _loop_8 = function (i) {
                                        var ul = $("#Account_TransactionList").find("ul:eq(0)");
                                        var liTemp = ul.find("li:eq(0)");
                                        var li = liTemp.clone(true);
                                        li.removeAttr("style");
                                        var tx = AntShares.Core.Transaction.deserializeFrom(txArray_1[i].rawData.hexToBytes().buffer);
                                        result_1 = result_1.then(function () {
                                            return tx.ensureHash();
                                        }).then(function () {
                                            li.find(".tx-time").text(new Date(parseInt(txArray_1[i].time) * 1000).toLocaleString());
                                            li.find(".tx-id").text(tx.hash.toString());
                                            li.find(".tx-id").bind("click", function () {
                                                var target = "_blank";
                                                var options = "location=yes";
                                                var inAppBrowserRef = cordova.InAppBrowser.open("http://antcha.in/tx/hash/" + tx.hash.toString(), target, options);
                                            });
                                    ...
                                    for (var i = 0; i < txArray_1.length; i++) {
                                        _loop_8(i);
                                    }
                                    return result_1;
                                };
                            ...
                            debugLog(UI.Resources.global.noTxs);
                        }).catch(function (e) {
                            alert(e);
                        });
                    };
                ...
                Index.prototype.onload = function () {
                    ...
                    $("#my_ans").text("0");
                    $("#my_anc").text("0");
                    var tx_ul = $("#Account_TransactionList").find("ul:eq(0)");
                    tx_ul.find("li.add").remove();
                    this.db = new AntShares.Implementations.Wallets.IndexedDB.WalletDataContext(AntShares.Global.Wallet.dbPath);
                    this.db.open().then(function () {
                        _this.loadTransactionList();
                    });
                    var asset_ul = $("#Tab_Account_Index").find("ul:eq(0)");
                    asset_ul.find(".add").remove();
                    var coins = AntShares.Global.Wallet.findCoins();
                    var map = new Map();
                    for (var i = 0; i < coins.length; i++) {
                        if (coins[i].state != AntShares.Wallets.CoinState.Unspent && coins[i].state != AntShares.Wallets.CoinState.Unconfirmed)
                            continue;
                        var key = coins[i].assetId.toString();
                        if (map.has(key)) {
                ...
                Index.addCoinList = function (item) {
                    var ul = $("#Tab_Account_Index").find("ul:eq(0)");
                    var liTemplet = ul.find("li:eq(0)");
                    var li = liTemplet.clone(true);
                    li.removeAttr("style");
                    AntShares.Core.Blockchain.Default.getTransaction(item.assetId).then(function (result) {
                        var asset = result;
    ...
    (function (UI) {
        ...
        (function (Account) {
            var Receive = (function (_super) {
                ...
                Receive.prototype.oncreate = function () {
                    $(this.target).find("#show_prikey").click(this.showPrivateKey);
                };
                Receive.prototype.onload = function () {
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    ...
                    AntShares.Global.Wallet.getContracts()[0].getAddress().then(function (result) {
                ...
                Receive.prototype.showPrivateKey = function () {
                    AntShares.Global.Wallet.getAccounts()[0].export().then(function (result) {
                        alert(result);
                    });
                };
                return Receive;
...
(function (AntShares) {
    ...
    (function (UI) {
        var Account;
        (function (Account) {
            var Send = (function (_super) {
                __extends(Send, _super);
                function Send() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.OnSendButtonClick = function () {
                        if (formIsValid("form_account_send")) {
                            var address_2 = $("#Tab_Account_Send .pay_address").val();
                            var value_1 = $("#Tab_Account_Send .pay_value").val();
                            var tx_2;
                            var context_3;
                            if ($("#Tab_Account_Send select>:selected").val() == 0) {
                                alert(UI.Resources.global.pleaseChooseAsset);
                                return;
                            }
                            var assetType = AntShares.Uint256.parse($("#Tab_Account_Send select>:selected").val());
                            if (assetType.equals(AntShares.Core.Blockchain.AntShare.hash) && value_1.indexOf(".") > -1) {
                                alert(UI.Resources.global.antshareIntegerOnly);
                                return;
                            }
                            Promise.resolve(1).then(function () {
                                return AntShares.Wallets.Wallet.toScriptHash(address_2);
                            }).then(function (result) {
                                tx_2 = new AntShares.Core.ContractTransaction();
                                tx_2.outputs = [new AntShares.Core.TransactionOutput()];
                                tx_2.outputs[0].assetId = AntShares.Uint256.parse($("#Tab_Account_Send select>:selected").val());
                                tx_2.outputs[0].scriptHash = result;
                                tx_2.outputs[0].value = AntShares.Fixed8.parse(value_1);
                                if (AntShares.Global.Wallet.makeTransaction(tx_2, AntShares.Fixed8.Zero) == null)
                                    throw new Error(UI.Resources.global.insufficientFunds);
                                return AntShares.Core.SignatureContext.create(tx_2, "AntShares.Core." + AntShares.Core.TransactionType[tx_2.type]);
                            }, function (onrejected) {
                                throw new Error(UI.Resources.global.addressError);
                            }).then(function (result) {
                                context_3 = result;
                                return AntShares.Global.Wallet.sign(context_3);
                            }).then(function (result) {
                                if (!result)
                                    throw new Error(UI.Resources.global.canNotSign);
                                if (!context_3.isCompleted())
                                    throw new Error(UI.Resources.global.thisVersion1);
                                tx_2.scripts = context_3.getScripts();
                                return AntShares.Global.Wallet.saveTransaction(tx_2);
                            }).then(function (result) {
                                if (!result)
                                    throw new Error(UI.Resources.global.txError1);
                                return AntShares.Global.Node.relay(tx_2);
                            }).then(function (result) {
                                UI.TabBase.showTab("#Tab_Account_Index");
                                formReset("form_account_send");
                                alert(UI.Resources.global.txId + tx_2.hash.toString());
                            }).catch(function (e) {
                                alert(e.message);
                            });
                        }
                    ...
                    _this.loadContactsList = function () {
                        var contacts;
                        UI.Contacts.Contact.instance().then(function (result) {
                            contacts = result;
                            return contacts.getContacts();
                        }).then(function (results) {
                            if (results.length > 0) {
                ...
                Send.prototype.oncreate = function () {
                    $("#Tab_Account_Send .btn-success").click(this.OnSendButtonClick);
                };
                Send.prototype.onload = function (args) {
                    if (AntShares.Global.Wallet == null) {
                        UI.TabBase.showTab("#Tab_Wallet_Open");
                        return;
                    }
                    ...
                    var assets = linq(AntShares.Global.Wallet.findUnspentCoins()).groupBy(function (p) { return p.assetId; }, function (k, g) {
                        return {
                            assetId: k,
                            amount: Send.sumf(g.select(function (p) { return p.value; }))
                        };
                    }).toArray();
                    Promise.all(linq(assets).select(function (p) { return AntShares.Core.Blockchain.Default.getTransaction(p.assetId); }).toArray()).then(function (results) {
                        var select = $("#Tab_Account_Send select");
                        select.html("");
                        select.append("<option value=0>" + UI.Resources.global.pleaseChoose + "</option>");
